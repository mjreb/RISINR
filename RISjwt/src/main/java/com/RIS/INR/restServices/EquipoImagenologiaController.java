...
public class EquipoImagenologiaController {
    ...
    public Response manageEquipoIMG(@PathParam("CRUD") String operacion, String formParams) { // 
        try{
            ...
            JsonNode jsonNode = mapper.readTree(formParams);
            ...
            switch (operacion) {
                case "ReadAll": 
                   ...
                   try{
                       jsonArray = equipoManager.consultarTodos(); 
